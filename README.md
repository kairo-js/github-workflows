...
jobs:
  build-and-push:
    uses: kairo-js/github-workflows/.github/workflows/docker-build-push.yml@v0.1.1
    with:
...
jobs:
  deploy:
    uses: kairo-js/github-workflows/.github/workflows/app-deploy.yml@v0.1.1
    with:
      app-name: werewolf
      image-prefix: mc-werewolf
...
jobs:
  deploy-caddy:
    needs: deploy
    uses: kairo-js/github-workflows/.github/workflows/caddy-snippet-deploy.yml@v0.1.1
    with:
      app-name: werewolf
...
jobs:
  backup:
    uses: kairo-js/github-workflows/.github/workflows/postgres-backup.yml@v0.1.1
    with:
      app-name: werewolf
...
jobs:
  release:
    uses: kairo-js/github-workflows/.github/workflows/web-app-release.yml@v0.1.1
    with:
      app-name: werewolf
      image-prefix: mc-werewolf
      services: '[{"name":"backend","context":"./backend"},{"name":"frontend","context":"./frontend"}]'
...
jobs:
  release:
    uses: kairo-js/github-workflows/.github/workflows/minecraft-pack-release.yml@v0.1.1
    permissions:
      contents: write
    with:
      artifact-name: kairo
